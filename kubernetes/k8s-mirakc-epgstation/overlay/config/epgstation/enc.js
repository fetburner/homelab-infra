...
// ビデオストリーム設定
Array.prototype.push.apply(args, ['-map', '0:v', '-c:v', 'h264_vaapi', '-level', '41']);
// インターレス解除
let resolution = "";
switch (process.env.VIDEORESOLUTION) {
    case "4320p":
        resolution = "scale_vaapi=w=7680:h=4320,";
        break;
    case "2160p":
        resolution = "scale_vaapi=w=3840:h=2160,";
        break;
    case "1080i":
        resolution = "scale_vaapi=w=1920:h=1080,";
        break;
    case "720p":
        resolution = "scale_vaapi=w=1280:h=720,";
        break;
    case "480p":
        resolution = "scale_vaapi=w=720:h=480,";
        break;
    case "480i":
        resolution = "scale_vaapi=w=720:h=480,";
        break;
    case "240p":
        resolution = "scale_vaapi=w=320:h=240,";
        break;
}
Array.prototype.push.apply(args, ['-vf', `format=nv12|vaapi,deinterlace_vaapi,${resolution}hwupload`]);
// オーディオストリーム設定
if (isDualMono) {
...
Array.prototype.push.apply(args, ['-c:a', 'libopus', '-b:a', '256k']);
// 品質設定
Array.prototype.push.apply(args, ['-qp', '24', '-compression_level', '0']);
// 出力ファイル
